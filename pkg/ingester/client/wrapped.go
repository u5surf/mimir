...
func (m *WrappedQueryStreamResponse) XXX_Unmarshal(b []byte) error { return m.Unmarshal(b) }
...
func (m *WrappedTimeSeriesChunk) XXX_Unmarshal(b []byte) error { return m.Unmarshal(b) }
